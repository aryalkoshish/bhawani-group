		...
		<div class="Content col-md-10" style="margin-top: 35px;"  >
			<div class="box box-info ">
				<div class="box-header with-border">
					...
					<form action="{{route('edit.article',$t->id)}}" method="post" enctype="multipart/form-data" >
						@csrf
						...
						<div class="form-group">
							...
							<input type="textarea" class="form-control" name="keywords" id="keywords" value="{{$t->seokeywords}}" >
						</div>
