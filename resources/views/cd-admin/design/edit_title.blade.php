		...
		<div class="Content col-md-10" style="margin-top: 35px;"  >
			<div class="box box-info ">
				<div class="box-header with-border">
					...
					<form action="{{route('edittitle',$s->id)}}" method="post" enctype="multipart/form-data" >
						@csrf						
						<div class="form-group">
							<div class="text text-danger">{{$errors->first('dtitle')}}</div>
							<label for="dtitle" >title</label>
							<input type="text" class="form-control" name="dtitle" id="dtitle" value="{{$s->dtitle}}" >
						</div>
						...
						<div class="form-group">
							...
							<input type="textarea" class="form-control" name="seokeyword" id="seokeyword" value="{{$s->seokeyword}}" >
						</div>
