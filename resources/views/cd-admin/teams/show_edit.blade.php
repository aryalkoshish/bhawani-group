		...
		<div class="Content col-md-10" style="margin-top: 35px;"  >
			<div class="box box-info ">
				<div class="box-header with-border">
					<h1 style="text-align: center;"> Edit Teams</h1>
					<form action="{{route('editteam',$s->id)}}" method="post" enctype="multipart/form-data" >
						@csrf
						...
						<div class="form-group">
							...
							<input type="textarea" class="form-control" name="post" id="post" value="{{$s->post}}" >
						</div>
